  ...
  <table border="0" align="center">
    <tr>
      <td align="center" valign="middle">
        <img src="logo.png" width="160" alt="SymbolLang Logo" /><br>
        <h1 style="margin-top: 5px; margin-bottom: 5px;">~!@#$%</h1>
        <b>始于 Word，不止于 Word</b><br>
        一门基于栈的符号驱动型编程语言
      </td>
    </tr>
  </table>
...
1. 允许任何个人或组织自由使用、修改、分发本项目的源代码，
   用于学习、研究、个人项目等非商业用途，
   但必须保留原始版权声明。

2. 未经作者书面许可，不得将本项目（包括修改后的版本）
   用于任何商业用途，包括但不限于：
   - 销售、倒卖、转售本软件或其修改版本
   - 销售本软件或其修改版本
   - 将本软件集成到商业产品中
...
4. 如需商业使用，请联系作者获取书面授权。

© 2024-2026 Creative Gears. All rights reserved.

## 授权与商业服务说明(许可证补充)
- **核心代码**：采用 MIT 许可证。任何人都可以自由使用、修改和分发源代码。
- **官方服务**：`SymbolLang_Pro` 及其包含的环境配置、疑难解答等专属服务，属于 Creative Gears 的独立商业服务。
- **禁止行为**：严禁未经授权将 `SymbolLang_Pro` 服务包进行二次打包并用于商业售卖。如发现此类行为，我们将保留追究法律责任的权利。
